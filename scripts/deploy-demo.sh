...
HOST="${DEMO_SSH_HOST:?set DEMO_SSH_HOST (see deploy/demo.env.example)}"
...
BUGIS_SECRET_KEY="${BUGIS_SECRET_KEY:?set BUGIS_SECRET_KEY (long random string)}"
