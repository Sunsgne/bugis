    ...
    <div>
      <Space style={{ marginBottom: 16, width: "100%", justifyContent: "space-between" }}>
        <div>
          ...
          <Text type="secondary">NETCONF / SSH 默认端口、账号与超时；纳管新设备时自动填充</Text>
        </div>
      ...
      <Alert
        ...
        description={
          <>
            ...
            <Link to="/settings/snmp">SNMP 采集</Link> 页面配置；单台设备可在「设备管理 → 凭证」中覆盖。
          </>
        }
      />
      ...
      <Form form={form} layout="vertical" disabled={loading}>
        <Row gutter={16}>
          ...
          <Col xs={12} md={6}>
            <Form.Item name="default_ssh_port" label="默认 SSH 端口">
              <InputNumber min={1} max={65535} style={{ width: "100%" }} />
            </Form.Item>
          </Col>
          <Col xs={12} md={6}>
            <Form.Item name="default_username" label="默认用户名">
        ...
        <Row gutter={16}>
          ...
          <Col xs={12} md={6}>
            <Form.Item name="ssh_timeout" label="SSH 超时 (秒)">
              <InputNumber min={5} max={300} style={{ width: "100%" }} />
            </Form.Item>
          </Col>
        </Row>
